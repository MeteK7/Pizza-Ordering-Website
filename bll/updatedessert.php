<?php 
    ...
    {   
        ...
        $sql_query = "UPDATE tbl_dessert SET name='$name', price_small='$price_small', price_medium='$price_medium', price_large='$price_large', availability='$availability' WHERE id='$id'";
        $query_run=$conn->query($sql_query);

        if($query_run)
        {
            echo '<script> alert("Data has been updated!"); </script>';
            header("Location:../dessert-management.php");
        }
        else
        {

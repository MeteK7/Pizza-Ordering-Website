		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="bll/addbeverage.php" method="POST">
						<div>
	...
	<div class="modal fade" id="modal-view">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Header -->
				<div class="modal-header">
					<h4 class="modal-title">Beverage Details</h4>
					<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
				</div>
	...
	<div class="modal fade" id="modal-update">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Header -->
				<div class="modal-header">
					<h4 class="modal-title">Edit Beverage</h4>
					<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
				</div>

				<!-- Modal Body -->
				<div class="modal-body">
					<form action="bll/updatebeverage.php" method="POST">
						<div>
							...
							<div class="col-lg-12">
								<div class="main-box clearfix">
									<div class="table-responsive">
										...
										?>
										<p>Beverage Count: <?php echo $row_count; ?></p>
						...
						if ($table_data->num_rows > 0) 
						{
							while($data = $table_data->fetch_assoc()) 
							{
								...
								<form action="bll/delete.php" method="post" class="fa-stack">
									...
									<input type="hidden" name="page-name" value="beverage-management.php"/>
								</form>
							</td>
						</tr>
						<?php

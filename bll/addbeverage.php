<?php 
    ...
    {   
        ...
        $sql_query = "INSERT INTO tbl_beverage (name, price_small, price_medium, price_large, availability) VALUES ('$name', '$price_small', '$price_medium', '$price_large', '$availability')";

<?php 
    ...
    {   
        ...
        $sql_query = "UPDATE tbl_pizza SET name='$name', price_small='$price_small', price_medium='$price_medium', price_large='$price_large', availability='$availability' WHERE id='$id'";

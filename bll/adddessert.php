<?php 
    ...
    {   
        ...
        $sql_query = "INSERT INTO tbl_dessert (name, price_small, price_medium, price_large, availability) VALUES ('$name', '$price_small', '$price_medium', '$price_large', '$availability')";
